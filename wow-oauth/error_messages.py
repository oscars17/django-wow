...
BNET_REDIRECT_URI = 'Battle.net redirect URI is not found. Please, add it to settings as BNET_REDIRECT_URI ' \
...
ACCESS_TOKEN = "No access token available"
ACCESS_CODE = "No access code provided"
